...
use App\DTO\UserAgregatedFinanceDataDTO;
...
class UserAgregatedFinanceDataService
{
    ...
    public function getAllUserAgregatedFinanceData(): UserAgregatedFinanceDataDTO
    {
