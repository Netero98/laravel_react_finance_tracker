        ...
        stage ('Prod') {
            ...
            steps {
                withCredentials([
                    ...
                    file(credentialsId: 'EXCHANGE_RATE_API_KEY_FILE', variable: 'EXCHANGE_RATE_API_KEY_FILE'),
                    string(credentialsId: 'EXCHANGE_RATE_API_URL', variable: 'EXCHANGE_RATE_API_URL'),
                    file(credentialsId: 'API_DB_PASSWORD_FILE', variable: 'API_DB_PASSWORD_FILE'),
                    string(credentialsId: 'DB_HOST', variable: 'DB_HOST'),
                    string(credentialsId: 'DB_PORT', variable: 'DB_PORT'),
                    string(credentialsId: 'DB_USER', variable: 'DB_USER'),
                    string(credentialsId: 'DB_NAME', variable: 'DB_NAME'),
                    string(credentialsId: 'CACHE_HOST', variable: 'CACHE_HOST'),
                    string(credentialsId: 'CACHE_PORT', variable: 'CACHE_PORT'),
                    string(credentialsId: 'CACHE_USER', variable: 'CACHE_USER'),
                    file(credentialsId: 'CACHE_PASSWORD_FILE', variable: 'CACHE_PASSWORD_FILE'),
                    usernamePassword(
                        credentialsId: 'REGISTRY_AUTH',
